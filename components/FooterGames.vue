<template>
  <div class="games parent row wrap grow v-end margin-top_base-phone">
    <lazy-image 
      ...
      class-name="game parent centered width_auto"
      relative
    />
  </div>
</template>
...
<script>
import { csgo, dota, hs, lol, ow } from "@/assets/images/logos";
export default {
  name: "FooterGames",
  mixins: [],
  data: () => ({
