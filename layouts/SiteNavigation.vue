  ...
  <nav 
    ...
    <ul class="parent row wrap">
      ...
      <li 
        ...
        <h1 >
          <a 
            :class="{'parent font-weight_extrabold text_nowrap h-centered_phone': true,
      ...
      <li 
        ...
        :key="index"
        class="parent centered navigationItem margin-top_zero"
      >
        <a 
          :aria-describedby="`
                ${link.name === currentPage ? 'currentPage' : ''}
              `"
          :href="link.href" 
          :class="{
